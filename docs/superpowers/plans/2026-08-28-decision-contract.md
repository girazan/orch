...
1. Premise para: "You decide once which decisions are yours. orch handles the rest — planned, reviewed, and gated by a frontier AI, executed by cheaper AI, shipped by whoever your contract says — with small programs (hooks) enforcing the rules the AI cannot talk its way past."
